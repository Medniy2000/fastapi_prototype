...
from src.app.domain.repositories.base import AbstractBaseRepository, BaseEntityType
...
class AbstractEntityService(AbstractBaseService, Generic[BaseEntityType]):
    @classmethod
...
class BaseEntityService(AbstractEntityService, Generic[BaseEntityType]):
